...
public class Graph_STUDENT_Test {
	...
	public void setUp() throws Exception {
		 graph = new Graph();
		  ...
		  graph.addEdge(town[1], town[2], 2, "Road_12");
		  graph.addEdge(town[1], town[3], 1, "Road_13");
		  graph.addEdge(town[2], town[5], 6, "Road_23");
		  graph.addEdge(town[3], town[6], 1, "Road_36");
	}
	...
	public void testGetEdge() {
		assertEquals(new Road(town[1], town[2],2, "Road_12"), graph.getEdge(town[1], town[2]));
		assertEquals(new Road(town[3], town[6],1, "Road_36"), graph.getEdge(town[3], town[6]));
	}

	@Test
	public void testAddEdge() {
		assertEquals(false, graph.containsEdge(town[3], town[5]));
		graph.addEdge(town[3], town[5], 1, "Road_35");
	...
	public void testEdgeSet() {
		...
		assertEquals("Road_13", roadArrayList.get(1));
	...
	public void testRemoveEdge() {
		...
		graph.removeEdge(town[1], town[2], 5, "Road_12");
