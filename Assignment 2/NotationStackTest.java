...
public class NotationStackTest {
	...
	public void testPopStudent() {
		try {
			assertEquals(Elmt_3, doubleS.pop());
			assertEquals(Elmt_2, doubleS.pop());
			assertEquals(Elmt_1, doubleS.pop());
	...
	public void testPushStudent() {
		try {
			assertEquals(3, stringS.size());
			assertEquals(true, doubleS.push(Elmt_4));
	...
	public void testToStringStudent() {
		try {
			assertEquals("24.98918.05.41", doubleS.toString());
			doubleS.push(Elmt_4);
			assertEquals("24.98918.05.418.9", doubleS.toString());
		} catch (Exception e) {
